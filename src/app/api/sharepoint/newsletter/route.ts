...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      const restUrl = `${siteUrl}/_api/web/GetFileByServerRelativeUrl('/sites/Thelounge/Shared Documents/CEO Newsletter/${fileName}')/$value`
      ...
      if (restResponse.ok) {
        ...
        const newsletter = {
          ...
          content: htmlContent,
          sharePointUrl: `${siteUrl}/Shared Documents/CEO Newsletter/${fileName}`,
